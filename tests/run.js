...
// cdp cleanup path hold no date code at all, so five runs would cost five times
// as long and prove exactly the same thing. Two of them have to earn their place
// here rather than merely claiming it — schedule-paste-core.js reads DAYS, and
...
const UNSWEPT_FILES = ['true-storage-core.test.js', 'graph-layout.test.js', 'doc-table-core.test.js',
  'schedule-paste-core.test.js', 'quest-core.test.js', 'viewport.test.js', 'cdp-cleanup.test.js'];
